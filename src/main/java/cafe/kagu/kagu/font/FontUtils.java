...
public class FontUtils {
	...
	public static final FontRenderer STRATUM2_REGULAR_10 = new FontRenderer(getFontFromInputStream(FontUtils.class.getResourceAsStream("stratum2_regular.ttf"), 20, Font.PLAIN), 0.5);
	public static final FontRenderer STRATUM2_REGULAR_13_AA = new FontRenderer(getFontFromInputStream(FontUtils.class.getResourceAsStream("stratum2_regular.ttf"), 26, Font.PLAIN), 0.5);
